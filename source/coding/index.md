...
**动态规划**	
[股票买卖最大利润](/2020/01/09/max-stock-profit/) [最大子序列](/2018/12/16/max-sub-array/) [抢劫房子](/2020/01/11/house-robber/) 最长回文串 二维数组中和最小路径 回文子串个数 爬楼梯的最小开销 最大乘积子序列 编辑距离 [动态规划合集](/2017/07/29/dynamic-programming/)
**随机算法**	
完美洗牌 数据流中概率相等的抽取
**高级数据结构**
LRU 缓存
